...
void showToast()
{
	if (toastTitle[0])
	{
		...
		toastArgs2.title = MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", toastTitle);
		toastArgs2.subtitle = MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", toastSubtitle);
...
void Toasts::showAdvancedNotification(const char* title, const char* subtitle, const char* iconsDict, const char* icon, int duration)
{
